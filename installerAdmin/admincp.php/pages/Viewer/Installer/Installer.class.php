...
class Installer extends Core {
	...
	global $manifest;
		...
		if(isset($_GET['install'])) {
			...
			$oldPath = array(
				"core".DS."class".DS."system".DS."DBDrivers".DS => str_replace(ROT_PATH, "", PATH_DB_DRIVERS),
				"core".DS."class".DS."system".DS => str_replace(ROT_PATH, "", PATH_SYSTEM),
				"core".DS."cache".DS."page".DS => str_replace(ROT_PATH, "", PATH_CACHE_PAGE),
				'core'.DS.'cache'.DS.'system'.DS => str_replace(ROT_PATH, "", PATH_CACHE_SYSTEM),
				'core'.DS.'cache'.DS.'system'.DS => str_replace(ROT_PATH, "", PATH_LOGS),
				"core".DS."cache".DS."tmp".DS => str_replace(ROT_PATH, "", PATH_CACHE_TEMP),
				'core'.DS.'cache'.DS.'lang'.DS => str_replace(ROT_PATH, "", PATH_CACHE_LANGS),
				"core".DS."cache".DS."session".DS => str_replace(ROT_PATH, "", PATH_CACHE_SESSION),
				"core".DS."class".DS => str_replace(ROT_PATH, "", PATH_CLASS),
				"core".DS."functions".DS => str_replace(ROT_PATH, "", PATH_FUNCTIONS),
				"core".DS."media".DS => str_replace(ROT_PATH, "", PATH_MEDIA),
				"core".DS."lang".DS => str_replace(ROT_PATH, "", PATH_LANGS),
				"core".DS."cache".DS => str_replace(ROT_PATH, "", PATH_CACHE),
				"core".DS."pages".DS => str_replace(ROT_PATH, "", PATH_PAGES),
				"application".DS."cache".DS => str_replace(ROT_PATH, "", PATH_CACHE_USERDATA),
				"application".DS."modules".DS => str_replace(ROT_PATH, "", PATH_MODULES),
				"application".DS."global".DS => str_replace(ROT_PATH, "", PATH_GLOBAL),
				"application".DS."autoload".DS => str_replace(ROT_PATH, "", PATH_AUTOLOADS),
				"application".DS."library".DS => str_replace(ROT_PATH, "", PATH_LOAD_LIBRARY),
				"application".DS."models".DS => str_replace(ROT_PATH, "", PATH_MODELS),
				"application".DS."cron".DS => str_replace(ROT_PATH, "", PATH_CRON_FILES),
				"application".DS => str_replace(ROT_PATH, "", PATH_LOADED_CONTENT),
				"skins".DS => str_replace(ROT_PATH, "", PATH_SKINS),
				"uploads".DS."manifest".DS => str_replace(ROT_PATH, "", PATH_MANIFEST),
				"uploads".DS => str_replace(ROT_PATH, "", PATH_UPLOADS),
