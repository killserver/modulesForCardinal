...
<span class="excel-head" >
	...
	<a href="./?pages=Excel&get&model={model_data}" target="_blank" class="btn btn-single btn-red">Скачать</a>
...
<script>
	...
	var loadExcelModel = './?pages=Excel&save&model={model_data}'
	var notifiedSuccess = "/admincp.php/?pages=Excel&update&model={model_data}"
</script>
