...
class Crush
{
    ...
    public static function init()
    {
        ...
        $pluginList = read_dir(self::$config->pluginDirs[0].DS);
        for($i=0;$i<sizeof($pluginList);$i++) {
            $pluginList[$i] = str_Replace(".".ROOT_EX, "", $pluginList[$i]);
        }
        ...
        self::$config->options = new Options(array("plugins" => $pluginList));
