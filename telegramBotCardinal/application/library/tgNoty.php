...
class tgNoty {
	...
	public static function noty($text, $type = "text", $config = array(), $files = array(), $fileChatList = "tgNoty_chatId.txt") {
		if(!defined("DS")) {
	...
	public static function notyToId($user_id, $text, $type = "text", $config = array(), $files = array()) {
		if(!defined("DS")) {
			define("DS", DIRECTORY_SEPARATOR);
		}
		define("ROOT_TG", dirname(__FILE__).DS);
